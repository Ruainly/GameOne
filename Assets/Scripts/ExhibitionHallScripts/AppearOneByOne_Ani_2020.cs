...
public class AppearOneByOne_Ani_2020 : MonoBehaviour
{
    ...
    public void ScriptAni()
    {
        ...
        DOVirtual.DelayedCall(0.8f, () =>
        {
            ...
            Images[13].DOLocalMove(TempPos[13], 0.3f);
            DOVirtual.DelayedCall(0.2f, () =>
            {
                Images[13].DOLocalMove(OriPos[13], 0.2f);
                Images[12].gameObject.SetActive(true);
                Images[12].DOLocalMove(TempPos[12], 0.3f);
                DOVirtual.DelayedCall(0.2f, () =>
                {
                    Images[12].DOLocalMove(OriPos[12], 0.2f);
                    Images[11].gameObject.SetActive(true);
                    Images[11].DOLocalMove(TempPos[11], 0.3f);
                    DOVirtual.DelayedCall(0.2f, () =>
                    {
                        Images[11].DOLocalMove(OriPos[11], 0.2f);
                        Images[10].gameObject.SetActive(true);
                        Images[10].DOLocalMove(TempPos[10], 0.3f);
                        DOVirtual.DelayedCall(0.2f, () =>
                        {
                            Images[10].DOLocalMove(OriPos[10], 0.2f);
                            Images[9].gameObject.SetActive(true);
                            Images[9].DOLocalMove(TempPos[9], 0.3f);
                            DOVirtual.DelayedCall(0.2f, () =>
                            {
                                Images[9].DOLocalMove(OriPos[9], 0.2f);
